...
import { bytesToHex, equalsBytes, hexToBytes } from "../bytes.js";
import { SYSTEM_ADDRESS } from "../constants.js";
import { EthereumJSErrorWithoutCode } from "../errors.js";
import { compareStorageSlotKeys } from "./compareStorageSlotKeys.js";
import { createBlockLevelAccessListFromJSON, } from "./index.js";
/**
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function countBlockAccessListItems(bal) {
    let items = 0;
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function validateBlockAccessListGasLimit(bal, blockGasLimit) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function validateBlockAccessList(bal, blockAccessListHash) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function validateBlockAccessListJSONStructure(json) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function isAccountOrderOnlyViolation(json) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function hashBlockAccessListFromJSON(json) {
    const accounts = [];
    for (const account of json) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function validateBlockAccessListHashFromJSON(json, expectedHash) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function validateBlockAccessListStructure(bal) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function validateBlockAccessListHash(bal, expectedHash) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function equalsBlockAccessList(a, b) {
