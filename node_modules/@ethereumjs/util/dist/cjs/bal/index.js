...
class BlockLevelAccessList {
    ...
    raw() {
        ...
        for (const address of Object.keys(this.accesses)
            ...
            const storageChanges = Object.entries(data.storageChanges)
                .sort((a, b) => (0, compareStorageSlotKeys_ts_1.compareStorageSlotKeys)(a[0], b[0]))
                .map(([slot, changes]) => [
            ...
            const storageReads = Array.from(data.storageReads)
                ...
                .sort((a, b) => (0, compareStorageSlotKeys_ts_1.compareStorageSlotKeys)(a, b));
     ...
     */
    get(address) {
        const key = (typeof address === 'string' ? address : address.toString()).toLowerCase();
     ...
     * @remarks Experimental (Amsterdam): may change on patch releases.
     */
    cleanupSelfdestructed(addresses, finalBalances) {
