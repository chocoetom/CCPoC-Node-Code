...
class EVM {
    ...
    constructor(opts) {
         ...
         */
        this.stateGasReservoir = util_1.BIGINT_0;
        /**
         * EIP-8037 cumulative state-gas used by the current transaction.
         *
         * @remarks Experimental (Amsterdam): may change on patch releases.
         */
        this.executionStateGasUsed = util_1.BIGINT_0;
        /**
         ...
         * @remarks Experimental (Amsterdam): may change on patch releases.
         */
        this.createTxTargetAlive = false;
        /**
     ...
     */
    chargeFrameStateGas(amount, gasLimit) {
        if (amount === util_1.BIGINT_0)
            return { remaining: gasLimit, spilled: util_1.BIGINT_0 };
        let spilled = util_1.BIGINT_0;
    ...
    async _executeCall(message) {
        ...
        // the frame.
        let accessStateSpill = util_1.BIGINT_0;
        if (message.depth === 0 && this.common.isActivatedEIP(2780) && !message.delegatecall) {
            ...
            if (message.value > util_1.BIGINT_0) {
                ...
                if (recipient === undefined || recipient.isEmpty()) {
                    const amount = this.common.param('stateBytesPerNewAccount') * (0, eip8037_ts_1.activeCostPerStateByte)(this.common);
            ...
            if (this.common.isActivatedEIP(7702)) {
                ...
                if ((0, util_1.equalsBytes)(recipientCode.slice(0, 3), types_ts_1.DELEGATION_7702_FLAG)) {
                    if (this.common.isActivatedEIP(7928)) {
        ...
        if (accessStateSpill > util_1.BIGINT_0) {
            result.stateGasSpilled = (result.stateGasSpilled ?? util_1.BIGINT_0) + accessStateSpill;
        }
    ...
    async _executeCreate(message) {
        ...
        if (this.common.isActivatedEIP(8037)) {
            const targetAlive = (await this.stateManager.getAccount(message.to)) !== undefined && !toAccount.isEmpty();
        ...
        if (exit) {
            ...
            return {
                ...
                execResult: {
                    ...
                    stateGasSpilled: accessStateSpill > util_1.BIGINT_0 ? accessStateSpill : undefined,
                },
            };
        }
        if (this.DEBUG) {
        ...
        let stateGasCreate = util_1.BIGINT_0;
        let stateGasFromReservoir = util_1.BIGINT_0;
        let stateGasSpillToGasLeft = util_1.BIGINT_0;
        if (!result.exceptionError && !this.common.isActivatedEIP(6800)) {
            if (this.common.isActivatedEIP(8037)) {
                ...
                //     runCall handler).
                const costPerStateByte = (0, eip8037_ts_1.activeCostPerStateByte)(this.common, this._block?.header.gasLimit);
        ...
        if (this.common.isActivatedEIP(8037) && createSucceeded) {
            if (stateGasCreate > util_1.BIGINT_0) {
                ...
                if (stateGasSpillToGasLeft > util_1.BIGINT_0) {
                    result.stateGasSpilled = (result.stateGasSpilled ?? util_1.BIGINT_0) + stateGasSpillToGasLeft;
                }
            }
            ...
            const prior = this.createdAccountStateGas.get(addrKey) ?? util_1.BIGINT_0;
    ...
    async runCall(opts) {
        ...
        if (err &&
            ...
            if (this.common.isActivatedEIP(8037)) {
                ...
                if (err.error === errors_ts_1.EVMError.errorMessages.REVERT) {
                    const spilled = result.execResult.stateGasSpilled ?? util_1.BIGINT_0;
                    if (spilled > util_1.BIGINT_0) {
                ...
                result.execResult.stateGasSpilled = util_1.BIGINT_0;
            }
            if (this.DEBUG) {
