...
exports.activeCostPerStateByte = activeCostPerStateByte;
exports.computeIntrinsicGasDimensions8037 = computeIntrinsicGasDimensions8037;
exports.txExceedsAvailableBlockGas8037 = txExceedsAvailableBlockGas8037;
 ...
 */
function activeCostPerStateByte(common, _blockGasLimit) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
function computeIntrinsicGasDimensions8037(common, tx, blockGasLimit, _sender) {
    const intrinsicRegular0 = tx.getIntrinsicGas();
    if (!common.isActivatedEIP(8037)) {
        return { intrinsicRegular: intrinsicRegular0, intrinsicState: util_1.BIGINT_0 };
    }
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
function txExceedsAvailableBlockGas8037(txGasLimit, txMaxGasLimit, blockGasLimit, blockRegularGasUsed, blockStateGasUsed) {
    const regularAvailable = blockGasLimit > blockRegularGasUsed ? blockGasLimit - blockRegularGasUsed : util_1.BIGINT_0;
    const stateAvailable = blockGasLimit > blockStateGasUsed ? blockGasLimit - blockStateGasUsed : util_1.BIGINT_0;
...
//# sourceMappingURL=eip8037.js.map