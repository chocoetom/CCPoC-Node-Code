...
exports.isEIP8024SingleImmediateValid = isEIP8024SingleImmediateValid;
exports.decodeEIP8024SingleImmediate = decodeEIP8024SingleImmediate;
exports.isEIP8024PairImmediateValid = isEIP8024PairImmediateValid;
exports.decodeEIP8024PairImmediate = decodeEIP8024PairImmediate;
 ...
 */
function isEIP8024SingleImmediateValid(immediate) {
 ...
 */
function decodeEIP8024SingleImmediate(immediate) {
    if (!isEIP8024SingleImmediateValid(immediate)) {
        (0, util_ts_1.trap)(errors_ts_1.EVMError.errorMessages.INVALID_OPCODE);
    }
 ...
 */
function isEIP8024PairImmediateValid(immediate) {
 ...
 * Traps with INVALID_OPCODE when the immediate is in the disallowed range.
 */
function decodeEIP8024PairImmediate(immediate) {
...
//# sourceMappingURL=EIP8024.js.map