...
const EIP8024_ts_1 = require("./EIP8024.js");
...
exports.handlers = new Map([
    ...
    [
        ...
        async function (runState) {
            ...
            const newIsZero = val === util_1.BIGINT_0;
            ...
            if (common.isActivatedEIP(8037) && originalIsZero) {
                ...
                const costPerStateByte = (0, eip8037_ts_1.activeCostPerStateByte)(common, runState.env.block.header.gasLimit);
                ...
                if (currentIsZero && !newIsZero) {
                    ...
                    const prior = evm.createdAccountStateGas.get(addrKey) ?? util_1.BIGINT_0;
                    ...
                    const evm = runState.interpreter._evm;
                    const prior = evm.createdAccountStateGas.get(addrKey) ?? util_1.BIGINT_0;
                    const next = prior > amount ? prior - amount : util_1.BIGINT_0;
    ...
    [
        ...
        function (runState, common) {
            ...
            const toDup = (0, EIP8024_ts_1.decodeEIP8024SingleImmediate)(immediate);
    ...
    [
        ...
        function (runState, common) {
            ...
            const immediate = (0, util_ts_2.readImmediateByteOrZero)(runState);
            const toSwap = (0, EIP8024_ts_1.decodeEIP8024SingleImmediate)(immediate);
    ...
    [
        ...
        function (runState, common) {
            ...
            const immediate = (0, util_ts_2.readImmediateByteOrZero)(runState);
            const [x, y] = (0, EIP8024_ts_1.decodeEIP8024PairImmediate)(immediate);
