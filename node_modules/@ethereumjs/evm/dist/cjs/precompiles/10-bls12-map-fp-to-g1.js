...
/** BLS12-381 field-element-to-G1 map precompile (0x10, EIP-2537). */
async function precompile10(opts) {
    ...
    try {
        ...
        const error = e instanceof errors_ts_1.EVMError ? e : new errors_ts_1.EVMError(errors_ts_1.EVMError.errorMessages.REVERT);
        if (opts._debug !== undefined) {
            opts._debug(`${pName} failed: ${e instanceof Error ? e.message : undefined}`);
        }
        return (0, evm_ts_1.EVMErrorResult)(error, opts.gasLimit);
    }
    if (opts._debug !== undefined) {
