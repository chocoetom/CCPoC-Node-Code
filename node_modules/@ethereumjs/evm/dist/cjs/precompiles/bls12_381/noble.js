...
const bls12_381_js_1 = require("@noble/curves/bls12-381.js");
const errors_ts_1 = require("../../errors.js");
const constants_ts_1 = require("./constants.js");
const G1_ZERO = bls12_381_js_1.bls12_381.G1.Point.ZERO;
const G2_ZERO = bls12_381_js_1.bls12_381.G2.Point.ZERO;
function BLS12_381_ToFp2Point(fpXCoordinate, fpYCoordinate) {
    ...
    const FP = bls12_381_js_1.bls12_381.fields.Fp2.fromBytes(fpBytes);
    return FP;
}
/**
...
function BLS12_381_ToG1Point(input, verifyOrder = true) {
    ...
    const G1 = bls12_381_js_1.bls12_381.G1.Point.fromAffine({
        x,
        y,
    });
    try {
...
function BLS12_381_ToG2Point(input, verifyOrder = true) {
    ...
    const pG2 = bls12_381_js_1.bls12_381.G2.Point.fromAffine({
        x: Fp2X,
        y: Fp2Y,
    });
    try {
...
function BLS12_381_ToFrPoint(input) {
    const Fr = bls12_381_js_1.bls12_381.fields.Fr.fromBytes(input);
    if (Fr >= bls12_381_js_1.bls12_381.fields.Fr.ORDER) {
        return bls12_381_js_1.bls12_381.fields.Fr.create(Fr % bls12_381_js_1.bls12_381.fields.Fr.ORDER);
    }
    return bls12_381_js_1.bls12_381.fields.Fr.create(Fr);
}
...
function BLS12_381_ToFpPoint(fpCoordinate) {
    ...
    const FP = bls12_381_js_1.bls12_381.fields.Fp.fromBytes(fpCoordinate.slice(16));
    return FP;
}
/**
...
class NobleBLS {
    ...
    mapFPtoG1(input) {
        ...
        const result = bls12_381_js_1.bls12_381.G1.mapToCurve(FP).toAffine();
    ...
    mapFP2toG2(input) {
        ...
        // @ts-expect-error - @noble/curves v2 type resolution mismatch
        const result = bls12_381_js_1.bls12_381.G2.mapToCurve([Fp2Point.c0, Fp2Point.c1]).toAffine();
    ...
    pairingCheck(input) {
        ...
        const FP12 = bls12_381_js_1.bls12_381.pairingBatch(filteredPairs, true);
        if (bls12_381_js_1.bls12_381.fields.Fp12.eql(FP12, bls12_381_js_1.bls12_381.fields.Fp12.ONE)) {
