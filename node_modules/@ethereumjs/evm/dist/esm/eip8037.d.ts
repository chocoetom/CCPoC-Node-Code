 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export declare function computeIntrinsicGasDimensions8037(common: Common, tx: IntrinsicDimensionsTx, blockGasLimit?: bigint, _sender?: {
    bytes: Uint8Array;
}): {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export declare function txExceedsAvailableBlockGas8037(txGasLimit: bigint, txMaxGasLimit: bigint, blockGasLimit: bigint, blockRegularGasUsed: bigint, blockStateGasUsed: bigint): boolean;
export {};
