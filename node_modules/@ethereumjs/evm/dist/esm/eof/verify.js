...
export const ContainerSectionType = {
    /** Subcontainer targeted by EOFCREATE (init code). */
    InitCode: 'initCode',
    /** Subcontainer targeted by RETURNCONTRACT (deployment code). */
    DeploymentCode: 'deploymentCode',
    /** Default runtime code section. */
    RuntimeCode: 'runtimeCode',
};
/**
 * Runs deep EOF opcode and stack validation (EIP-5450 and related rules).
 *
 * @returns Map from subcontainer index to its {@link ContainerSectionType}.
 */
