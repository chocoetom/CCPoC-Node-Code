import { SYSTEM_ADDRESS_BYTES, bigIntToBytes, bytesToBigInt, bytesToHex, equalsBytes, hexToBytes, setLengthLeft, } from '@ethereumjs/util';
/**
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export const EIP7708_BURN_TOPIC = hexToBytes('0xcc16f5dbb4873280815c1ee09dbd06736cffcc184412cf7a71a0fdb75d397ca5');
/**
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function createEIP7708BurnLog(account, value) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function decodeEIP7708TransferLog(log) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function decodeEIP7708BurnLog(log) {
    const [address, topics, data] = log;
