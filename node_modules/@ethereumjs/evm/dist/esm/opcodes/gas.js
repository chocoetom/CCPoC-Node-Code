...
import { chargeSstoreAccessEIP8038, updateSstoreGasEIP2200, updateSstoreGasEIP8038, } from "./EIP2200.js";
import { accessAddressEIP2929, accessStorageEIP2929, addAddressToBAL, getAddressAccessCost, warmAddress, } from "./EIP2929.js";
import { callFamilyGas, create7928Gas, createNewAccountStateGasIfCharged } from "./EIP7928.js";
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            const loadSlot = async () => ({
                currentStorage: setLengthLeftStorage(await runState.interpreter.storageLoad(keyBytes, false, false)),
                originalStorage: setLengthLeftStorage(await runState.interpreter.storageLoad(keyBytes, true, false)),
            });
            ...
            if (common.isActivatedEIP(8038)) {
                ...
                gas += updateSstoreGasEIP8038(runState, currentStorage, originalStorage, setLengthLeftStorage(value), keyBytes, common);
