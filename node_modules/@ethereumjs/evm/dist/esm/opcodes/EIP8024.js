 ...
 */
export function isEIP8024SingleImmediateValid(immediate) {
 ...
 */
export function decodeEIP8024SingleImmediate(immediate) {
 ...
 */
export function isEIP8024PairImmediateValid(immediate) {
 ...
 * Traps with INVALID_OPCODE when the immediate is in the disallowed range.
 */
export function decodeEIP8024PairImmediate(immediate) {
