 ...
 */
export function activeCostPerStateByte(common, _blockGasLimit) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function computeIntrinsicGasDimensions8037(common, tx, blockGasLimit, _sender) {
 ...
 * @remarks Experimental (Amsterdam): may change on patch releases.
 */
export function txExceedsAvailableBlockGas8037(txGasLimit, txMaxGasLimit, blockGasLimit, blockRegularGasUsed, blockStateGasUsed) {
    const regularAvailable = blockGasLimit > blockRegularGasUsed ? blockGasLimit - blockRegularGasUsed : BIGINT_0;
    const stateAvailable = blockGasLimit > blockStateGasUsed ? blockGasLimit - blockStateGasUsed : BIGINT_0;
