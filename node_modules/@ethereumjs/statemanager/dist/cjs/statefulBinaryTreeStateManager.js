...
const consumeBAL_ts_1 = require("./consumeBAL.js");
...
class StatefulBinaryTreeStateManager {
    constructor(opts) {
        ...
        this.putCode = async (address, value) => {
            ...
            const codeHash = (0, sha3_js_1.keccak_256)(value);
        ...
        this.hashFunction = opts.hashFunction ?? blake3_js_1.blake3;
        this._tree =
            opts.tree ??
    ...
    async consumeBAL(bal, expectedStateRoot) {
        return (0, consumeBAL_ts_1.consumeBAL)(this, bal, expectedStateRoot);
    }
