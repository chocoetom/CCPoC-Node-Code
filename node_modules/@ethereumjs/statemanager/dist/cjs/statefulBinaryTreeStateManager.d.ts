...
import type { Address, BALJSONBlockAccessList, BinaryTreeExecutionWitness, PrefixedHexString } from '@ethereumjs/util';
import { Account } from '@ethereumjs/util';
import { OriginalStorageCache } from './cache/originalStorageCache.ts';
import type { AccountFields, BinaryTreeAccessWitnessInterface, BinaryTreeAccessedStateWithAddress, BinaryTreeStateManagerInterface, GenesisState, StateManagerInterface, StorageDump, StorageRange } from '@ethereumjs/common';
 ...
 */
export declare class StatefulBinaryTreeStateManager implements StateManagerInterface, BinaryTreeStateManagerInterface {
