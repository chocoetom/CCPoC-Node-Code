...
import { Address, BIGINT_0, BIGINT_1, BIGINT_2, EthereumJSErrorWithoutCode, GWEI_TO_WEI, KECCAK256_RLP, TypeOutput, bytesToBigInt, createBlockLevelAccessList, createWithdrawal, createZeroAddress, toBytes, toType, validateBlockAccessListGasLimit, } from '@ethereumjs/util';
...
export class BlockBuilder {
    ...
    constructor(vm, opts) {
         ...
         */
        this.blockRegularGasUsed = BIGINT_0;
        /**
         * EIP-8037 state-dimension accumulator (0 when the EIP is inactive).
         */
        this.blockStateGasUsed = BIGINT_0;
        /**
    ...
    async addTransaction(tx, { skipHardForkValidation, allowNoBlobs, } = {}) {
        ...
        if (this.vm.common.isActivatedEIP(8037)) {
            if (txExceedsAvailableBlockGas8037(tx.gasLimit, tx.common.param('maxTransactionGasLimit'), blockGasLimit, this.blockRegularGasUsed, this.blockStateGasUsed)) {
    ...
    async build(sealOpts) {
        ...
        if (this.vm.common.isActivatedEIP(7685)) {
            ...
            requests = await accumulateRequests(this.vm, this.transactionResults, this.headerData.gasLimit !== undefined
