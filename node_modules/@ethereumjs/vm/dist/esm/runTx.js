...
import { BinaryTreeAccessWitness, EVMError, activeCostPerStateByte, computeIntrinsicGasDimensions8037, createEIP7708BurnLog, } from '@ethereumjs/evm';
...
async function _runTx(vm, opts) {
    ...
    const { intrinsicRegular: intrinsicRegularGas, intrinsicState: intrinsicStateGas } = computeIntrinsicGasDimensions8037(tx.common, tx, block?.header.gasLimit, caller);
    ...
    if (vm.common.isActivatedEIP(8037)) {
        ...
        const regularBudget = txMaxGasLimit > intrinsicRegularGas ? txMaxGasLimit - intrinsicRegularGas : BIGINT_0;
