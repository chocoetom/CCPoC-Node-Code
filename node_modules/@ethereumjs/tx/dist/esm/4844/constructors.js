...
import { CELLS_PER_EXT_BLOB, EthereumJSErrorWithoutCode, bigIntToHex, blobsToCellProofs, blobsToCells, blobsToCommitments, blobsToProofs, bytesToBigInt, bytesToHex, bytesToInt, commitmentsToVersionedHashes, computeVersionedHash, equalsBytes, getBlobs, intToHex, validateNoLeadingZeroes, } from '@ethereumjs/util';
import { paramsTx } from "../params.js";
import { TransactionType } from "../types.js";
import { accessListBytesToJSON } from "../util/access.js";
import { Blob4844Tx, NetworkWrapperType } from "./tx.js";
...
export function createBlob4844TxFromSerializedNetworkWrapper(serialized, opts) {
    ...
    const networkWrapperVersionInt = bytesToInt(networkWrapperVersion);
    if (networkWrapperVersionInt !== NetworkWrapperType.EIP4844 &&
