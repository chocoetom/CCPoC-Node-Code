import { BIGINT_0, EthereumJSErrorWithoutCode, MAX_INTEGER, TypeOutput, bigIntToHex, bigIntToUnpaddedBytes, bytesToBigInt, bytesToInt, hexToBytes, intToUnpaddedBytes, toBytes, toType, } from '@ethereumjs/util';
...
import { accessListJSONToBytes } from "../util/access.js";
import { getBaseJSON, getCommon, sharedConstructor, validateNotArray, valueOverflowCheck, } from "../util/internal.js";
...
export class Blob4844Tx {
    ...
    constructor(txData, opts = {}) {
        this.type = TransactionType.BlobEIP4844; // 4844 tx type
        this.cache = {};
        /**
        ...
        const networkWrapperVersion = txData.networkWrapperVersion !== undefined
            ? bytesToInt(toBytes(txData.networkWrapperVersion))
            : undefined;
    ...
    serializeNetworkWrapper() {
        ...
        const networkSerialized = this.networkWrapperVersion === NetworkWrapperType.EIP4844
