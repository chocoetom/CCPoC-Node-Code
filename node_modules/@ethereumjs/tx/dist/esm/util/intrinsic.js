 ...
 */
export function getEip2780RecipientRegularGas(tx, sender) {
 ...
 * `TX_BASE` alone.
 */
export function getEip2780FloorBaseGas(tx, sender) {
 ...
 */
export function countCalldataFloorTokens(tx) {
    let tokens = 0n;
 ...
 */
export function getCalldataFloorGas(tx, sender) {
 ...
 */
export function getMinimumGasLimit(tx, sender) {
 ...
 */
export function getEip7702IntrinsicAuthGas(tx) {
