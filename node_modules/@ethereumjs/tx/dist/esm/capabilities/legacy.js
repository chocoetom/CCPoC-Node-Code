import { Address, BIGINT_0, EthereumJSErrorWithoutCode, SECP256K1_ORDER_DIV_2, bigIntToUnpaddedBytes, bytesToHex, ecrecover, publicToAddress, unpadBytes, } from '@ethereumjs/util';
import { secp256k1 } from '@noble/curves/secp256k1.js';
import { keccak_256 } from '@noble/hashes/sha3.js';
import { Capability, TransactionType } from "../types.js";
import { getCalldataFloorGas, getEip2780RecipientRegularGas, getEip7702IntrinsicAuthGas, getMinimumGasLimit, } from "../util/intrinsic.js";
...
export function getValidationErrors(tx) {
    ...
    if (minGas > tx.gasLimit) {
        const bound = floor > intrinsic
            ? `calldata floor ${floor} (intrinsic ${intrinsic})`
            : `intrinsic gas ${intrinsic}`;
        errors.push(`gasLimit is too low. The gasLimit is lower than the minimum gas limit of ${minGas} (${bound}), the gas limit is: ${tx.gasLimit}`);
    }
    return errors;
}
/**
