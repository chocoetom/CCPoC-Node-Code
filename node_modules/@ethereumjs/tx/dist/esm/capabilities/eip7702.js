...
import { EthereumJSErrorWithoutCode, MAX_INTEGER, MAX_UINT64, bytesToBigInt, eoaCode7702AuthorizationListBytesItemToJSON, validateNoLeadingZeroes, } from '@ethereumjs/util';
/**
 ...
 */
export function getAuthorizationListJSON(tx) {
    if (tx.cache.authorityListJSON !== undefined) {
        return tx.cache.authorityListJSON;
    }
    const authorityListJSON = tx.authorizationList.map((item) => eoaCode7702AuthorizationListBytesItemToJSON(item));
