...
import { getBaseJSON, sharedConstructor, valueOverflowCheck } from "../util/internal.js";
...
function validateVAndExtractChainID(common, _v) {
    ...
    if (v !== undefined && v !== 0 && common.gteHardfork('spuriousDragon') && v !== 27 && v !== 28) {
        if (!meetsEIP155(BigInt(v), common.chainId())) {
            throw EthereumJSErrorWithoutCode(`Incompatible EIP155-based V ${v} and chain id ${common.chainId()}. Pass a matching \`common\` option to createLegacyTx (or the relevant create*Tx factory).`);
        }
...
export class LegacyTx {
     ...
     * the module-level factory functions such as {@link createLegacyTx},
     * {@link createLegacyTxFromRLP}, and {@link createLegacyTxFromBytesArray}.
     */
