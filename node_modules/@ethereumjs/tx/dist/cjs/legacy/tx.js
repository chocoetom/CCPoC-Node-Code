...
function validateVAndExtractChainID(common, _v) {
    ...
    if (v !== undefined && v !== 0 && common.gteHardfork('spuriousDragon') && v !== 27 && v !== 28) {
        if (!meetsEIP155(BigInt(v), common.chainId())) {
            throw (0, util_1.EthereumJSErrorWithoutCode)(`Incompatible EIP155-based V ${v} and chain id ${common.chainId()}. Pass a matching \`common\` option to createLegacyTx (or the relevant create*Tx factory).`);
        }
