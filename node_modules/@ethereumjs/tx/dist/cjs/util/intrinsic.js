...
exports.getEip2780RecipientRegularGas = getEip2780RecipientRegularGas;
exports.getEip2780FloorBaseGas = getEip2780FloorBaseGas;
exports.countCalldataFloorTokens = countCalldataFloorTokens;
exports.getCalldataFloorGas = getCalldataFloorGas;
exports.getMinimumGasLimit = getMinimumGasLimit;
exports.getEip7702IntrinsicAuthGas = getEip7702IntrinsicAuthGas;
 ...
 */
function getEip2780RecipientRegularGas(tx, sender) {
    ...
    if (from !== undefined && tx.to !== undefined && (0, util_1.equalsBytes)(tx.to.bytes, from.bytes)) {
        return util_1.BIGINT_0;
    }
 ...
 * `TX_BASE` alone.
 */
function getEip2780FloorBaseGas(tx, sender) {
 ...
 */
function countCalldataFloorTokens(tx) {
    let tokens = 0n;
    ...
    if (tx.common.isActivatedEIP(7981) && tx.supports(types_ts_1.Capability.EIP2930AccessLists)) {
 ...
 */
function getCalldataFloorGas(tx, sender) {
    if (!tx.common.isActivatedEIP(7623)) {
        return util_1.BIGINT_0;
    }
    return (getEip2780FloorBaseGas(tx, sender) +
 ...
 */
function getMinimumGasLimit(tx, sender) {
    const intrinsic = tx.getIntrinsicGas();
    if (!tx.common.isActivatedEIP(7623)) {
        return intrinsic;
    }
    return (0, util_1.bigIntMax)(intrinsic, getCalldataFloorGas(tx, sender));
}
/**
 ...
 */
function getEip7702IntrinsicAuthGas(tx) {
    if (!tx.common.isActivatedEIP(8037) || !tx.supports(types_ts_1.Capability.EIP7702EOACode)) {
        return util_1.BIGINT_0;
    }
